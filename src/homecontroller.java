...
public class homecontroller {
  ...
  if(emailFild.getText().isBlank() == false && passwordFild.getText().isBlank() == false){
    ...
    String Varifylogin = "SELECT count(1) FROM  userinformation WHERE email = '"+emailFild.getText()+"' AND password = '"+passwordFild.getText()+"';";
    ...
    void reg1(ActionEvent event) throws IOException {
        ...
        Parent tvp = FXMLLoader.load(getClass().getResource("signup.fxml"));
        Scene scene =  new Scene(tvp);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(scene);
        window.show();
